...
public class DataProviderSTTest {
    DataProviderST hibernate = new DataProviderST();
    ...
    public void BirdsTest() {
        System.out.println(hibernate.saveBirds(name, breed, gender, age, weight, VAC, NUM, "Birds").getId());
        System.out.println(hibernate.getBirds(ID));
        System.out.println(hibernate.updateBirds(ID, UPDATE, breed, gender, NUM, NUM, VAC, NUM, "Bird0s").getAnswer());
        System.out.println(hibernate.getBirds(ID));
