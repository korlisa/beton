...
import ru.sfedu.vetClinicH.lab3.JoinedTable.*;
import ru.sfedu.vetClinicH.utils.HibernateUtilJT;


import static ru.sfedu.vetClinicH.constants.Constants.*;
import static ru.sfedu.vetClinicH.constants.Constants.FAIL;

public class DataProviderJT implements IDataProviderHibernate {
    private static Logger log = LogManager.getLogger(DataProviderJT.class);
    private Session openSession(){
        return HibernateUtilJT.getSessionFactory().openSession();
    }
