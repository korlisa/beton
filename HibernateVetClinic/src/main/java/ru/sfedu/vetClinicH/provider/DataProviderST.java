...
import ru.sfedu.vetClinicH.lab3.SingleTable.Birds;
import ru.sfedu.vetClinicH.lab3.SingleTable.Mammals;
import ru.sfedu.vetClinicH.lab3.SingleTable.Reptiles;

import ru.sfedu.vetClinicH.utils.HibernateUtilST;

import static ru.sfedu.vetClinicH.constants.Constants.*;
import static ru.sfedu.vetClinicH.constants.Constants.FAIL;

public class DataProviderST implements IDataProviderHibernate {
    private static Logger log = LogManager.getLogger(DataProviderST.class);
    private Session openSession(){
        return HibernateUtilST.getSessionFactory().openSession();
    }
    ...
    public Result saveMammals(String name, String breed, String gender, int age, int weight, boolean vac, int woolLength, String type) {
        ...
        return new Result(Status.NO, SAVED);
    }
